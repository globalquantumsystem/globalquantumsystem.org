...
export const getEmailVerificationTemplate = (name: string, url: string) => {
    ...
    <head>
        ...
        <title>Verify Your Email - Global Quantum System</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="message">
                    Welcome to Global Quantum System To complete your account setup and secure your crypto assets, please verify your email address.
                </p>
                ...
                <p class="message" style="font-size: 13px;">
                    ...
                    If you didn't sign up for Global Quantum System, please ignore this email. Your email address will not be used unless you complete the verification process.
                </p>
            </div>

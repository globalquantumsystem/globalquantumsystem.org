...
export const getResetPasswordTemplate = (name: string, url: string) => {
    ...
    <head>
        ...
        <title>Reset Your Password - Global Quantum System</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="message">
                    We received a request to reset the password for your Global Quantum System account. If you didn't make this request, you can safely ignore this email.
                </p>
                ...
                <div class="warning">
                    <strong>🔒 Security Notice:</strong> Never share this link with anyone. Global Quantum System staff will never ask for your password or this link.
                </div>

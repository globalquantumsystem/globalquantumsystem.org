...
export const getAccountDeletionConfirmationTemplate = (name: string, url: string) => {
    ...
    <html lang="en">
      <head>
          ...
          <title>Confirm Account Deletion - Global Quantum System</title>
          <style>
              body {
      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <p class="message">
                      We received a request to delete your Global Quantum System account. To proceed with the deletion, please confirm by clicking the button below.
                  </p>
